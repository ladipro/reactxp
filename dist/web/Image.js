...
var DEFAULT_RESIZE_MODE = 'contain';
...
var Image = /** @class */ (function (_super) {
    ...
    Image.prototype.render = function () {
        ...
        var reactElement = (React.createElement("div", { style: this._getStyles(), onMouseUp: this._onMouseUp, title: this.props.title, "data-test-id": this.props.testId },
            optionalImg,
            this.props.children));
    ...
    Image.prototype._buildBackgroundSize = function (resizeMode) {
        if (resizeMode === void 0) { resizeMode = DEFAULT_RESIZE_MODE; }
        switch (resizeMode) {
            case 'repeat':
                return 'auto';
            case 'stretch':
